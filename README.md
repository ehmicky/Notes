...
- __Streams__
  ...
  - [json text sequence (Format)](Architecture/Async/Streams/json_text_sequence.format.txt)
...
- __Tree__
  - __CSON__
    - [cson (Node CLI)](Data/Serialization/Tree/CSON/cson.node_cli.txt)
  - __ESON__
    - [eson (Node)](Data/Serialization/Tree/ESON/eson.node.txt)
  - __INI__
    - __Parser serializer__
      - [ini (Node)](Data/Serialization/Tree/INI/Parser_serializer/ini.node.txt)
    - [ini (Format)](Data/Serialization/Tree/INI/ini.format.txt)
  - __JSON__
    - __Syntax__
      - [json (Format)](Data/Serialization/Tree/JSON/Syntax/json.format.txt)
    - __Circular__
      - [circular-json-es6 (Node)](Data/Serialization/Tree/JSON/Circular/circular-json-es6.node.txt)
      - [circular-json (JavaScript)](Data/Serialization/Tree/JSON/Circular/circular-json.javascript.txt)
      - [json-stringify-safe (Node)](Data/Serialization/Tree/JSON/Circular/json-stringify-safe.node.txt)
      - [safe-json-stringify (Node)](Data/Serialization/Tree/JSON/Circular/safe-json-stringify.node.txt)
  - __JSON5__
    - [JSON5 (Format)](Data/Serialization/Tree/JSON5/JSON5.format.txt)
    - [json5 (JavaScript)](Data/Serialization/Tree/JSON5/json5.javascript.txt)
  - __TOML__
    - __Parsers serializers__
      - [toml-node (JavaScript)](Data/Serialization/Tree/TOML/Parsers_serializers/toml-node.javascript.txt)
    - [toml (Format)](Data/Serialization/Tree/TOML/toml.format.txt)
  - __XML__
    - __Syntax__
      - [XML (Format)](Data/Serialization/Tree/XML/Syntax/XML.format.txt)
  - __YAML__
    - __Linting__
      - [yamllint (CLI)](Data/Serialization/Tree/YAML/Linting/yamllint.cli.txt)
    - __Parser serializer__
      - [js-yaml (JavaScript)](Data/Serialization/Tree/YAML/Parser_serializer/js-yaml.javascript.txt)
      - [yaml.js (JavaScript)](Data/Serialization/Tree/YAML/Parser_serializer/yaml.js.javascript.txt)
    - [yaml (Format)](Data/Serialization/Tree/YAML/yaml.format.txt)
...
- __Semantic web__
  - __Linked data__
    ...
    - __JSON pointer__
      - [json-pointer (Node)](RPC/Inter_process/Semantic_web/Linked_data/JSON_pointer/json-pointer.node.txt)
      - [json-ptr (JavaScript)](RPC/Inter_process/Semantic_web/Linked_data/JSON_pointer/json-ptr.javascript.txt)
      - [json pointer (Format)](RPC/Inter_process/Semantic_web/Linked_data/JSON_pointer/json_pointer.format.txt)
      - [jsonpointer.js (JavaScript)](RPC/Inter_process/Semantic_web/Linked_data/JSON_pointer/jsonpointer.js.javascript.txt)
      - [node-jsonpointer (Node)](RPC/Inter_process/Semantic_web/Linked_data/JSON_pointer/node-jsonpointer.node.txt)
- __URI routing__
  - __Client side__
